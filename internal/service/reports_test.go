...
func TestReportService_List(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			q:       "",
			status:  "open",
			err:     errs.ErrListReportInvalidParams,
			listErr: nil,
		},
		{
		...
		},
		{
			...
			q:       "",
			status:  "",
			err:     errs.ErrReportStatusRequired,
			listErr: nil,
		},
		{
			...
			q:       "",
			status:  "pending",
			err:     errs.ErrInvalidReportStatus,
			listErr: nil,
		},
		{
...
func TestReportService_Create(t *testing.T) {
	tests := []struct {
	...
	}{
		{
			...
			createErr:    nil,
			err:          errs.ErrCourseNameAndLinkUrlAreRequired,
			resultWanted: nil,
		},
		{
